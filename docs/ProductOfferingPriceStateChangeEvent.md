...
------------ | ------------- | ------------- | -------------
**Event** | [***ProductOfferingPriceStateChangeEventPayload**](ProductOfferingPriceStateChangeEventPayload.md) | The event payload linked to the involved resource object | [optional] [default to null]
