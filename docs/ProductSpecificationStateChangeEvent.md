...
------------ | ------------- | ------------- | -------------
**Event** | [***ProductSpecificationStateChangeEventPayload**](ProductSpecificationStateChangeEventPayload.md) | The event payload linked to the involved resource object | [optional] [default to null]
